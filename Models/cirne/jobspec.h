...
#		endif
	...
	int rank(){
		//return 0;  
                return js_queued; // Ana: This was fixed to be arrival time, since later it impacts ordering of jobs from earlier to later arrival. 
	}
...
void writestatic( List<JobSpec>* jobspeclist, char* workload_fn, char* extension = "static", char* partition ="*" );
void writestatic_swf( List<JobSpec>* jobspeclist, char* workload_fn, char* extension = "swf", char* partition ="*" );
