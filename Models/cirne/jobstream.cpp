...
// for the max num nodes (CPUs) 8192 set n_ul1 to 0.07 and n_ul2 to 0.09
// for the max num nodes (CPUs) 2048 set n_ul1 to 0.09 and n_ul2 to 0.01 
// for the max num nodes (CPUs) 256 set n_ul1 to 0.1 and n_ul2 to 0.2 
// for the max num nodes (CPUs) 128 set n_ul1 to 0.1 and n_ul2 to 0.3 
// for the max num nodes (CPUs) 8 set n_ul1 to 0.2 and n_ul2 to 0.4 
// for the max num nodes (CPUs) 32 set n_ul1 to 0.1 and n_ul2 to 0.5 
// for the max num nodes (CPUs) 64 set n_ul1 to 0.1 and n_ul2 to 0.4 
//const double n_ul1 = 0.12;
const double n_ul1 = 0.1;
//const double n_ul2 = 0.20;
const double n_ul2 = 0.4; 
// if n_p2_frac is 1 all jobs are of size that is a power of two
//const double n_p2_frac = 0.75; //default
const double n_p2_frac = 0.10;
//const double n_p2_frac = 1;
...
{
//	return ( ProbRandom() <= pc ); not interested for now
	return 0;
}
