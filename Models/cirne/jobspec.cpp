...
void writestatic( List<JobSpec>* jobspeclist, char* workload_fn, char* extension, char* partition )
{
...
/**
 *  Write #jobspeclist# into the SWF file #workload_fn#.#extension#, making all jobs look static submissions
 */

void writestatic_swf( List<JobSpec>* jobspeclist, char* workload_fn, char* extension, char* partition )
{
        ...
        const char* minusone = "-1";
        const char one = '1';
        const char* jobname = "tester";
        // #80000;88339;-1;3220;1;-1;-1;-1;-1;-1;1;tester;-1;-1;1;esb;-1;-1;-1
        for( JobSpec* jobspec = jobspeclist->getfirst(); jobspec != NULL; jobspec = jobspeclist->getnext() ){
                staticworkload << minusone << semicolon
                                           << jobspec->js_queued << semicolon
                                           << minusone << semicolon
                                           << jobspec->js_finish-jobspec->js_start << semicolon
                                           << jobspec->js_nodes << semicolon
                                           << minusone << semicolon
                                           << minusone << semicolon
                                           << minusone << semicolon
                                           << jobspec->js_reqtime << semicolon
                                           << minusone << semicolon
                                           << one << semicolon
                                           << jobname << semicolon
                                           << minusone << semicolon
