...
enum Model_ModelID {
  ...
  Model_ModelID_EAR_ENERGY = 3,
  Model_ModelID_EAR_POWER = 4,
  Model_ModelID_EAR_TIME = 5,
...
const Model_ModelID Model_ModelID_ModelID_MAX = Model_ModelID_EAR_TIME;
...
class Model : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:config.Model) */ {
 public:
  ...
  static const ModelID TIME =
    Model_ModelID_TIME;
  static const ModelID EAR_ENERGY =
    Model_ModelID_EAR_ENERGY;
  static const ModelID EAR_POWER =
    Model_ModelID_EAR_POWER;
  static const ModelID EAR_TIME =
    Model_ModelID_EAR_TIME;
